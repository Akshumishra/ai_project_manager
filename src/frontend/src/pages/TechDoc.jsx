...
export default function TechDoc() {
  ...
  const [chatStatus, setChatStatus] = useState("Agent is preparing the first technical draft...");
  ...
  async function sendMessage() {
    ...
    try {
      const data = await sendTechDocAgentMessage(activeProjectId, message, DEFAULT_USER_ID);
      setMessages((prev) => {
