...
async def post_task_mapping_notification(project_id: str, agent_response: str) -> bool:
    ...
    try:
        ...
        blocks = [
            {
                "type": "header",
                "text": {"type": "plain_text", "text": "🚀  Meeting Intelligence: Action Plan Ready"}
            },
            {
                "type": "section",
                "text": {"type": "mrkdwn", "text": f"*Summary Reference*: {plan.get('meeting_summary_ref', 'N/A')}"}
            }
        ]
        ...
        if new_tasks:
            ...
            blocks.append({"type": "section", "text": {"type": "mrkdwn", "text": text_part}})
        ...
        blocks.append({
            "type": "context",
            "elements": [{"type": "mrkdwn", "text": "View full details on the project dashboard."}]
        })
